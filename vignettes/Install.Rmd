...
```{r,eval=FALSE}
# test whether blastp is corretly installed on your machine
...
__You should see this output if BLAST was installed corretly.__
...
[__ProteinOrtho__](https://www.bioinf.uni-leipzig.de/Software/proteinortho/) is an orthology inference tool for large-scale analysis.
